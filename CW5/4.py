...
#Proszę napisać funkcję, która policzy występujące
#w tablicy ciągi arytmetyczne (LA) i geometryczne (LG)
#o długości większej niż 2. Funkcja powinna
#zwrócić wartość 1 gdy LA > LG, wartość -1 gdy LA < LG 
#oraz 0 gdy LA = LG
